        ...
        <div class="proContent">
            <div class="list">
                <div class="priceSum" v-if="ishave">
                    ...
                    <button class="endbtn">结算</button>
                    <div class="mobliebtn">
                        <div class="btn-left">
                            <span class="btn-left-1">总计</span>
                            <span class="btn-left-2">{{ total }}</span>
                        </div>
                        <button class="btn-right">结算</button>
                    </div>
                    <p class="priceSum-m">
                        ...
                        <tr>
                            <td class="shopping indexk">
                                ...
                                <div class="shopping-left">
                                    <img :src="'http://localhost/' + c.imgName.split(',')[0]" alt="">
...
import { computed, nextTick, onBeforeMount, onMounted, ref, toRef, toRefs, watch, watchEffect } from 'vue';
...
let cart = ref(cartStore.cartItems)
let ishave = ref(false)
let totalPrice = ref(0)
let total = ref('')
let n = ref(0)
let flag = ref(false)
let oldItems=cart.value
onBeforeMount(async () => {
    getCar()
